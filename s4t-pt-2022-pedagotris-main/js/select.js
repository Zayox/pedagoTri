...
playBtn.addEventListener("click", (e)=>{
  ...
  (inputValArrInt.length<5 || inputValArrInt.length>20) ? (nbValues.style.display = "block", state=false) : (nbValues.style.display = "none", state=true);


  if(state===true && check===true && container.childElementCount===0){
    valuesError.style.display = "none";
    nbValues.style.display = "none";
...
async function bblSort(arr){
  ...
  sorted = true;
  playBtnImg.src = "./images/refresh-white.png";
...
async function selectionSort(inputArr) {
  ...
  for(let i = 0; i < n; i++) {
    ...
    explanationText.innerHTML = "Recherche de la plus petite valeur...";
    let min = i;
    container.children[i].style.backgroundColor = "orange";
    for(let j = i+1; j < n; j++){
      await waitforme(selector.value === "x2" ? 300 : 1000);
      ifCondition.style.backgroundColor = "";
      ifCondition.style.color = "";
      ...
      secondFor2.style.backgroundColor = "yellow";
      secondFor2.style.color = "blue";
      container.children[j].style.backgroundColor = "orange";
    ...
    if (min != i) {
      await waitforme(selector.value === "x2" ? 300 : 1000);
      explanationText.innerHTML = "La plus petite valeur est : " + container.children[min].textContent;
      container.children[min].style.backgroundColor = "green";
      await waitforme(selector.value === "x2" ? 300 : 1000);
      secondFor.style.backgroundColor = "";
      secondFor.style.color = "";
      firstFor.style.backgroundColor = "";
      ...
      for(let i=0;i<inputValArrInt.length;i++){
        container.children[i].style.backgroundColor = "skyblue";
      }
    ...
    container.children[iTest].style.backgroundColor = "green";
    iTest++;
  }
